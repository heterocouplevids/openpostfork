...
8. Start MCP with authenticated remote metadata and safe read/create/schedule tools. Remote auth, workspace listing, account listing, draft creation, scheduled posting, status reads, scheduled-post cancellation, and next-slot suggestions are in place.
