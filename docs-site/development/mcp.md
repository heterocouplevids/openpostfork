...
- Validates workspace membership and account ownership before returning or creating data.
- Returns structured content so assistants can inspect workspace, account, and draft IDs without parsing prose.
